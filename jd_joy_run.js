...
//下面给出好友邀请助力的示例填写规则
let invite_pins = ['18674856364_p,gem5830,jd_5f9e360e6a8d7,jd_4e48f4ed5abf6,jd_67fcb585e4607,jd_SatdgDSJaNcV'];
//下面给出好友赛跑助力的示例填写规则
let run_pins = ['18674856364_p,gem5830,jd_5f9e360e6a8d7,jd_4e48f4ed5abf6,jd_67fcb585e4607,jd_SatdgDSJaNcV'];
//friendsArr内置太多会导致IOS端部分软件重启,可PR过来(此处目的:帮别人助力可得30g狗粮)
let friendsArr = ["18674856364_p,gem5830,jd_5f9e360e6a8d7,jd_4e48f4ed5abf6,jd_67fcb585e4607,jd_SatdgDSJaNcV"]
    ...
    if (cookiesArr[i]) {
      ...
      if ($.isNode()) {
        if (process.env.JOY_RUN_HELP_MYSELF) {
          ...
          let fixPins = run_pins.splice(run_pins.indexOf('18674856364_p'), 1);
          fixPins.push(...run_pins.splice(run_pins.indexOf('gem5830'), 1));
          fixPins.push(...run_pins.splice(run_pins.indexOf('jd_5f9e360e6a8d7'), 1));
